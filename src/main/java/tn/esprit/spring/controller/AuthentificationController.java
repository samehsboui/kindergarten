...
import tn.esprit.spring.dto.request.auth.LoginRequest;
import tn.esprit.spring.dto.request.auth.SignUpRequest;
...
public class AuthentificationController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
		...
		User user = new User(fullName, signUpRequest.getUsername(), signUpRequest.getEmail(),
				encoder.encode(signUpRequest.getPassword()), new Date(), null, null, new Date(),null,null);
